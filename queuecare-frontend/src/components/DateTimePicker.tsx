...
> extends Omit<TextFieldProps, 'variant' | 'defaultValue' | 'onChange'> {
  /**
  ...
  /**
   * Date/time value (if not using React Hook Form)
   */
  value?: string;

  /**
   * Callback for value change (if not using React Hook Form)
   */
